...
public class GetBusByRouteMessageProcessorDebuggable
    extends GetBusByRouteMessageProcessor
    implements DebugInfoProvider
{


    public GetBusByRouteMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("route", "Route", (java.lang.String.class), route, muleEvent));
