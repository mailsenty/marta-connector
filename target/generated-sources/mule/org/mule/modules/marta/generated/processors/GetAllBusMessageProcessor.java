...
/**
 * GetAllBusMessageProcessor invokes the {@link org.mule.modules.marta.MARTAConnector#getAllBus()} method in {@link MARTAConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-15T06:33:40-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class GetAllBusMessageProcessor
    extends DevkitBasedMessageProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{


    public GetAllBusMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((MARTAConnector) object).getAllBus();
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at MARTAConnector at getAllBus retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
